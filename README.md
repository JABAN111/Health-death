...
Важно: На текущий момент конфигурационные файлы не добавлены и не планируется их добавление в ближайшее время. Для локальной развертки
либо используйте hard coding, либо настройте переменные окружения (env).
